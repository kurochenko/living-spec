...
Context is not a primitive type — it has no file of its own. It exists as a `context` field in every primitive's frontmatter and as an optional namespace prefix in qualified refs (`context.prefix:slug`).
