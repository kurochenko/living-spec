...
import { CONTEXTS_DIR, CONTEXT_TEMPLATE, SPEC_DIR } from '../lib/constants.js'
import { specContent } from '../lib/seed/spec.js'
import { contextTemplateContent } from '../lib/seed/templates.js'
import { CURRENT_SPEC_VERSION, versionContent } from '../lib/seed/version.js'
...
export const migrateCommand = new Command('migrate')
  ...
  .action(() => {
    ...
    if (!isVersionLessThan(currentVersion, CURRENT_SPEC_VERSION)) {
      console.error(`Error: Spec version ${currentVersion} is newer than CLI version ${CURRENT_SPEC_VERSION}.`)
