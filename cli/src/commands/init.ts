...
export const initCommand = new Command('init')
  ...
  .action((opts: { dir: string }) => {
    ...
    console.log('')
    console.log('Use the `lore` CLI to query and update the spec:')
    console.log('  lore show <prefix:slug>       — read a primitive')
    console.log('  lore show <prefix:slug> --related — see its subgraph')
    console.log('  lore check <prefix:slug>      — completeness check (dead refs, deprecated)')
    console.log('  lore list [--type <type>]      — list all primitives')
    console.log('  lore add <type> <slug> -n "Name" -b body.md — create a primitive')
    console.log('  lore link <source> <edge> <target> — add a typed edge')
    console.log('')
